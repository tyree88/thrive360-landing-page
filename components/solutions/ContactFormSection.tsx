...
export default function ContactFormSection({
  title = "Get in Touch",
  description = "Have questions or ready to start transforming your teletherapy? Send us a message!",
  customClassName = ""
  ...
  return (
    <section className={`py-16 md:py-24 bg-gradient-contact-form text-brand-gray-50 ${customClassName}`}>
