...
import { faArrowRight, faHospital, faUniversity } from '@fortawesome/free-solid-svg-icons';
import { faAmazon, faGoogle, faMicrosoft, faApple } from '@fortawesome/free-brands-svg-icons';
      ...
      <div className="max-w-7xl mx-auto px-6 py-32 relative z-10 text-center">
        ...
        >
          <AnimatedButton 
            ...
            variant="gradient"
            size="lg"
            icon={<FontAwesomeIcon icon={faArrowRight} aria-hidden="true" />}
            className="shadow-lg"
          >
        ...
        >
          ...
          <div className="flex justify-center items-center space-x-8 flex-wrap gap-y-4">
            ...
            <div className="h-10 w-24 opacity-80 flex items-center justify-center text-white" aria-label="Amazon logo">
              <FontAwesomeIcon icon={faAmazon} size="2x" />
            </div>
            <div className="h-10 w-24 opacity-80 flex items-center justify-center text-white" aria-label="Google logo">
              <FontAwesomeIcon icon={faGoogle} size="2x" />
            </div>
            <div className="h-10 w-24 opacity-80 flex items-center justify-center text-white" aria-label="Microsoft logo">
              <FontAwesomeIcon icon={faMicrosoft} size="2x" />
            </div>
            <div className="h-10 w-24 opacity-80 flex items-center justify-center text-white" aria-label="Apple logo">
              <FontAwesomeIcon icon={faApple} size="2x" />
            </div>
            <div className="h-10 w-24 opacity-80 flex items-center justify-center text-white" aria-label="Hospital icon">
              <FontAwesomeIcon icon={faHospital} size="2x" />
            </div>
            <div className="h-10 w-24 opacity-80 flex items-center justify-center text-white" aria-label="University icon">
